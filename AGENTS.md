...
4. Map/list relationship: improve how users switch between map and results, especially on mobile. Status: in progress with mobile list/map toggle, desktop companion map, card-to-marker action, and active result highlighting.
