...
5. Gym result cards: make cards easier to scan, with clearer hierarchy and actions. Status: in progress with steadier card layout, clearer info blocks, tappable phone, tighter actions, less duplicate labeling, and stronger selected-card state.
