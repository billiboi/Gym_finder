        ...
        <div class="rounded-2xl border border-slate-200 bg-white/90 p-4">
          ...
          <p class="mt-3 text-sm leading-7 text-slate-600">
            {#if data.persistentClaimFlow}
              La richiesta pu essere salvata direttamente dal sito.
            {:else}
              In questo ambiente il salvataggio diretto non  disponibile, ma puoi comunque usare la mail precompilata.
            {/if}
          </p>
        </div>
      </div>
