...
export function normalizeGym(gym, fallbackId = '') {
  ...
  const normalized = {
    ...
    verified_commercial_info: toBoolean(firstValue(gym, ['verified_commercial_info'], false)),
    commercial_info_last_checked_at: firstValue(gym, ['commercial_info_last_checked_at'], null) || null,
    source_url: clean(firstValue(gym, ['source_url'])),
